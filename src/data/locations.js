...
const locations = [
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1546290204-e3cacbe309f1?w=400&h=300&fit=crop',
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1529148482759-b649effa3142?w=400&h=300&fit=crop',
  },
  {
    name: 'Maleeha Cafe',
    category: 'sisterly',
    ...
    lat: 40.8495,
    lng: -73.8618,
    description: 'Maleeha Cafe is a Yemeni-owned women-only cafe in the Bronx that serves Yemeni coffee and local baked goods. The space allows women to gather comfortably, remove face coverings, and relax in a community that values safety, culture, and dignity. With private rooms available for events, the cafe creates a calming environment centered on women\'s comfort and community.',
    badge: 'girls day',
    emoji: '☕',
    mapLabel: 'Bronx',
  ...
  },
  {
    ...
    lat: 40.7724,
    lng: -73.9718,
    description: 'Created by Meredith Bergmann and installed in 2020, the Women\'s Rights Pioneers Monument honors Sojourner Truth, Susan B. Anthony, and Elizabeth Cady Stanton. It was the first monument in Central Park to depict real women. The sculpture shows the three women working together, symbolizing activism, friendship, and shared purpose.',
    badge: 'study date',
    emoji: '👩‍🎨',
